#!/bin/bash
# Uninstall statistical-research plugin from Claude Code
...
echo -e "${BLUE}=== Statistical Research Plugin Uninstaller ===${NC}"
echo ""
...
echo -e "  cd ~/projects/dev-tools/claude-plugins/statistical-research"
